...
export default {
  ...
  getters: {
    ...
    currentPlayIndex: (state) => state.currentPlayIndex,
		...
		isLoopPlay: (state) => state.isLoopPlay,
		rePlayThisSong: (state) => state.rePlayThisSong
  },
  mutations: {
    ...
    setCurrentPlayIndex: (state, currentPlayIndex) => {
      state.currentPlayIndex = currentPlayIndex;
		...
		setIsLoopPlay: (state, isLoopPlay) => {
			state.isLoopPlay = isLoopPlay
		},
		setReplayThisSong: (state, rePlayThisSong) => {
			state.rePlayThisSong = rePlayThisSong
		}
  },
  actions: {
